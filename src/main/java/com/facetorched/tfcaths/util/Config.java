...
public class Config {
	...
	public static void reloadPlants() {
		...
		athsPlantHelper(AthsGlobal.BRISTLE_FERN, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"High Hills","Lake","Foothills","Lakeshore","Riverbank","Swamp","Mountain Range","Mountains", "Mountain Range Edge","Mountains Edge"}, new String[]{"Asia","Americas"},
		...
		athsPlantHelper(AthsGlobal.CHANTERELLE, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"}, new String[]{"High Hills","Plains","High Hills Edge","Rolling Hills","High Plains","Lake","Foothills","Lakeshore","Riverbank","Swamp"}, new String[]{"Europe"},
		...
		athsPlantHelper(AthsGlobal.CLIFF_BRAKE, new int[] {0}, new String[] {"ore:stone"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas","Africa"},
		...
		athsPlantHelper(AthsGlobal.CLIMBING_ROSE, new int[] {0,1,2}, new String[] {"alltrees", "ore:stone"}, new String[]{"Plains","Rolling Hills","Lakeshore","Riverbank","Swamp","High Hills","High Hills Edge"}, new String[]{"Americas","Asia","Africa","Europe"},
		...
		athsPlantHelper(AthsGlobal.COBRA_LILY, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[] {"Swamp","Estuary","Salt Swamp","Lakeshore","Riverbank","Plains"}, new String[]{"Americas"},
		...
		athsPlantHelper(AthsGlobal.COMMON_STINKHORN, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"High Hills","Plains","High Hills Edge","Rolling Hills","High Plains","Lake","Foothills","Lakeshore","Riverbank","Swamp"}, new String[]{"Americas", "Asia", "Europe"},
		...
		athsPlantHelper(AthsGlobal.EASTERN_SKUNK_CABBAGE, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Lake","Lakeshore","Riverbank","Swamp","River"}, new String[]{"Americas"},
		...
		athsPlantHelper(AthsGlobal.FIELD_HORSETAIL, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Plains","Lake","Lakeshore","Riverbank","Swamp","Salt Swamp","Estuary"}, new String[]{"Americas", "Asia", "Europe"},
		...
		athsPlantHelper(AthsGlobal.INDIGO_MILK_CAP, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"High Hills","Plains","High Hills Edge","Rolling Hills","High Plains","Lake","Foothills","Lakeshore","Riverbank","Swamp"}, new String[]{"Americas"},
		...
		athsPlantHelper(AthsGlobal.JUNIPER, new int[] {0,1,2,3,4}, new String[] {"ore:blockSoil","ore:blockSand","ore:blockGravel","ore:stone"}, new String[] {"All","!Ocean","!Hell","!Deep Ocean", "!Beach", "!Shore", "!Lakeshore"}, new String[]{"Americas","Asia","Europe","Africa"},
		...
		athsPlantHelper(AthsGlobal.JUNIPER + "_Desert", AthsGlobal.JUNIPER, new int[] {0,1,2,3,4,5}, new String[] {"ore:blockSoil","ore:blockSand","ore:blockGravel","ore:stone"}, new String[] {"All","!Ocean","!Hell","!Deep Ocean", "!Beach", "!Shore", "!Lakeshore"}, new String[]{"Americas","Asia","Europe","Africa"},
		...
		athsPlantHelper(AthsGlobal.LIVERWORT_EPIPHYTE, new int[] {0}, new String[] {"ore:stone"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia","Americas","Europe","Africa"},
				/*size*/22, /*dispersion*/1, /*rarity*/6796, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/-15f, /*maxTemp*/40f, /*minRain*/800f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/7f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.LIVERWORT_EPIPHYTE + "_Cliff", AthsGlobal.LIVERWORT, new int[] {0}, new String[] {"ore:stone"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia","Americas","Europe","Africa"},
				/*size*/22, /*dispersion*/1, /*rarity*/1796, /*minAltitude*/0, /*maxAltitude*/155, /*minTemp*/-15f, /*maxTemp*/40f, /*minRain*/700f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/7f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.LOOSE_FLOWERED_ORCHID, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"High Plains","Estuary","Plains","Swamp","Salt Swamp","Riverbank","Lakeshore","Rolling Hills"}, new String[]{"Europe","Asia"},
		...
		athsPlantHelper(AthsGlobal.MAGNOLIA2 + "_Asia", AthsGlobal.MAGNOLIA2, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia"},
				/*size*/4, /*dispersion*/15, /*rarity*/7000, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/11f, /*maxTemp*/29f, /*minRain*/650f, /*maxRain*/1200f, /*minEVT*/1f, /*maxEVT*/10f,/*forestGen*/0.5f);
		athsPlantHelper(AthsGlobal.MAGNOLIA2, new int[] {0,1,2,3}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
				/*size*/4, /*dispersion*/15, /*rarity*/7000, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/7f, /*maxTemp*/23f, /*minRain*/650f, /*maxRain*/2000f, /*minEVT*/1f, /*maxEVT*/10f,/*forestGen*/0.5f);
		...
		athsPlantHelper(AthsGlobal.MEDIUM_UNDERGROWTH + "_Savanna", AthsGlobal.MEDIUM_UNDERGROWTH, new int[] {0,1,2}, new String[] {"ore:blockSoil"}, new String[]{"High Hills","Plains","High Hills Edge","Rolling Hills","High Plains","Lake","Foothills","Lakeshore","Riverbank","Swamp","Salt Swamp"}, new String[]{"Americas", "Asia", "Africa", "Europe"},
		...
		athsPlantHelper(AthsGlobal.MEXICAN_GIANT_HORSETAIL, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Lake","Estuary","Lakeshore","Riverbank","Swamp","River"}, new String[]{"Americas"},
		...
		athsPlantHelper(AthsGlobal.MOONWORT, new int[] {0}, new String[] {"ore:blockSoil"}, new String[]{"High Hills","Plains","High Hills Edge","Rolling Hills","High Plains","Lake","Foothills","Lakeshore","Riverbank","Swamp"}, new String[]{"Americas", "Asia", "Europe","Africa"},
		...
		athsPlantHelper(AthsGlobal.MOREL, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"High Hills","Plains","High Hills Edge","Rolling Hills","High Plains","Lake","Foothills","Lakeshore","Riverbank","Swamp"}, new String[]{"Americas", "Asia", "Europe","Africa"},
		...
		athsPlantHelper(AthsGlobal.ORANGE_MYCENA, new int[] {1}, new String[] {"whiteelm","willow","aspen","maple","birch","oak","sycamore","hickory","chestnut","ash","ginkgo"}, AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
		...
		athsPlantHelper(AthsGlobal.OYSTER_MUSHROOM, new int[] {0}, new String[] {"alltrees"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia","Americas","Europe","Africa"},
				/*size*/1, /*dispersion*/1, /*rarity*/4500, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/5f, /*maxTemp*/34f, /*minRain*/820f, /*maxRain*/16000f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.POISON_IVY, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"High Hills","Plains","High Hills Edge","Rolling Hills","High Plains","Lake","Foothills","Lakeshore","River","Lake","Riverbank","Swamp"}, new String[]{"Americas", "Asia"},
		...
		athsPlantHelper(AthsGlobal.RIVER_CANE, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[] {"Swamp","Salt Swamp","Riverbank","Lakeshore","Lake","River"}, new String[]{"Americas"},
		...
		athsPlantHelper(AthsGlobal.ROSEBUSH, new int[] {0,1,2}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Plains","Rolling Hills","Lakeshore","Riverbank","Swamp","High Hills","High Hills Edge"}, new String[]{"Africa","Americas","Asia","Europe"},
		...
		athsPlantHelper(AthsGlobal.ROUGH_HORSETAIL, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Plains","Lake","Lakeshore","Riverbank","Swamp","Salt Swamp","Estuary"}, new String[]{"Americas", "Asia", "Europe"},
		...
		athsPlantHelper(AthsGlobal.ROYAL_FERN + "American_Swamp", AthsGlobal.ROYAL_FERN, new int[] {1}, new String[] {"ore:blockSoil"}, new String[]{"Lake","Lakeshore","Riverbank", "River","Swamp"}, new String[]{"Americas"},
		...
		athsPlantHelper(AthsGlobal.ROYAL_FERN /*Eurasian*/, new int[] {0}, new String[] {"ore:blockSoil"}, AthsGlobal.LAND_BIOMES, new String[]{"Asia"},
				/*size*/15, /*dispersion*/4, /*rarity*/4768, /*minAltitude*/0, /*maxAltitude*/180, /*minTemp*/-1f, /*maxTemp*/15f, /*minRain*/890f, /*maxRain*/1500f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/0.7f);
		athsPlantHelper(AthsGlobal.ROYAL_FERN /*Eurasian_Swamp*/, new int[] {0}, new String[] {"ore:blockSoil"}, new String[]{"Lake","Lakeshore","Riverbank", "River","Swamp"}, new String[]{"Asia"},
				/*size*/18, /*dispersion*/2, /*rarity*/3968, /*minAltitude*/0, /*maxAltitude*/160, /*minTemp*/-1f, /*maxTemp*/15f, /*minRain*/890f, /*maxRain*/1500f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/0.7f);
		...
		athsPlantHelper(AthsGlobal.SALTWORT + "_Riverbank", AthsGlobal.SALTWORT, new int[] {0,1}, new String[] {"ore:blockSoil","ore:blockSand","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Riverbank"}, new String[]{"Americas"},
		...
		athsPlantHelper(AthsGlobal.SAXIFRAGE /*London's Pride*/, new int[] {0}, new String[] {"ore:blockSoil", "ore:blockSand","ore:blockGravel","ore:stone"}, new String[] {"Mountains","Mountain Range","Mountains Edge","Mountain Range Edge", "Foothills"}, new String[]{"Europe"},
				/*size*/18, /*dispersion*/10, /*rarity*/3280, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/-20f, /*maxTemp*/7f, /*minRain*/160f, /*maxRain*/810f, /*minEVT*/1f, /*maxEVT*/10f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.SCALY_SAWGILL, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Europe","Africa"},
				/*size*/2, /*dispersion*/2, /*rarity*/5096, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/-10f, /*maxTemp*/15f, /*minRain*/250f, /*maxRain*/16000f, /*minEVT*/0.25f, /*maxEVT*/3f,/*forestGen*/1.0f);
		...
		athsPlantHelper(AthsGlobal.SENSITIVE_FERN, new int[] {0}, new String[] {"ore:blockSoil"}, new String[]{"Lake","Lakeshore","Riverbank", "River","Swamp"}, new String[]{"Asia","Americas"},
		...
		athsPlantHelper(AthsGlobal.SUNDEW, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Mountains","Mountain Range", "Swamp","Salt Swamp"}, new String[]{"Americas","Africa"},
		...
		athsPlantHelper(AthsGlobal.SWAMP_HORSETAIL, new int[] {0}, new String[] {"ore:blockSoil", "terrafirmacraftplus:FreshWaterStationary","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Lake","Estuary","Lakeshore","Riverbank","Swamp","River"}, new String[]{"Europe","Asia","Americas"},
		...
		athsPlantHelper(AthsGlobal.TRUMPET_PITCHER + "_Green", AthsGlobal.TRUMPET_PITCHER, new int[] {1}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[] {"Swamp","Salt Swamp","Riverbank","Lakeshore","Lake","River"}, new String[]{"Americas"},
				/*size*/10, /*dispersion*/4, /*rarity*/4184, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/13f, /*maxTemp*/20f, /*minRain*/620f, /*maxRain*/1500f, /*minEVT*/0f, /*maxEVT*/4f,/*forestGen*/0.5f);
		athsPlantHelper(AthsGlobal.TRUMPET_PITCHER + "_Purple", AthsGlobal.TRUMPET_PITCHER, new int[] {2}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[] {"Swamp","Salt Swamp","Riverbank","Lakeshore","Lake","River"}, new String[]{"Americas"},
				/*size*/7, /*dispersion*/4, /*rarity*/5184, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/13f, /*maxTemp*/20f, /*minRain*/620f, /*maxRain*/1500f, /*minEVT*/0f, /*maxEVT*/4f,/*forestGen*/0.5f);
		athsPlantHelper(AthsGlobal.TRUMPET_PITCHER + "_Sweet", AthsGlobal.TRUMPET_PITCHER, new int[] {3}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[] {"Swamp","Salt Swamp","Riverbank","Lakeshore","Lake","River"}, new String[]{"Americas"},
				/*size*/10, /*dispersion*/4, /*rarity*/4884, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/-6f, /*maxTemp*/12f, /*minRain*/620f, /*maxRain*/2000f, /*minEVT*/0f, /*maxEVT*/4f,/*forestGen*/0.5f);
		athsPlantHelper(AthsGlobal.TRUMPET_PITCHER /*Cane_Brake*/, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[] {"Swamp","Salt Swamp","Riverbank","Lakeshore","Lake","River"}, new String[]{"Americas"},
				/*size*/10, /*dispersion*/4, /*rarity*/4584, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/12f, /*maxTemp*/20f, /*minRain*/620f, /*maxRain*/1500f, /*minEVT*/0f, /*maxEVT*/4f,/*forestGen*/0.5f);
		...
		athsPlantHelper(AthsGlobal.WESTERN_SKUNK_CABBAGE, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Lake","Lakeshore","Riverbank","Swamp","River","Mountain Range","Mountain Range Edge","Foothills","Mountais","Mountains Edge"}, new String[]{"Americas"},
		...
		athsPlantHelper(AthsGlobal.WHITE_SKUNK_CABBAGE, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat","terrafirmacraftplus:PeatGrass"}, new String[]{"Lake","Lakeshore","Riverbank","Swamp","River"}, new String[]{"Asia"},
		...
		athsPlantHelper(AthsGlobal.BAY_BOLETE, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Europe","Asia"},
		...
		athsPlantHelper(AthsGlobal.BICOLOR_BOLETE, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Asia"},
		...
		athsPlantHelper(AthsGlobal.BLUSHER, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Asia","Europe","Africa"},
		...
		athsPlantHelper(AthsGlobal.CAESAR_MUSHROOM, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Asia","Europe"},
		...
		athsPlantHelper(AthsGlobal.CAESAR_MUSHROOM + "_American", AthsGlobal.CAESAR_MUSHROOM, new int[] {1}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
				/*size*/3, /*dispersion*/2, /*rarity*/4996, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/7f, /*maxTemp*/26f, /*minRain*/690f, /*maxRain*/1400f, /*minEVT*/0f, /*maxEVT*/8f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.CAULIFLOWER_MUSHROOM, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Europe"},
		...
		athsPlantHelper(AthsGlobal.DEER_MUSHROOM, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Europe"},
		...
		athsPlantHelper(AthsGlobal.EARTHY_INOCYBE, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass","ore:blockGravel"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Europe"},
		...
		athsPlantHelper(AthsGlobal.FAIRY_FINGERS, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Africa","Europe","Asia"},
		...
		athsPlantHelper(AthsGlobal.GREEN_QUILTED_RUSSULA, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Africa","Europe","Asia"},
				/*size*/6, /*dispersion*/5, /*rarity*/3996, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/3f, /*maxTemp*/20f, /*minRain*/750f, /*maxRain*/1600f, /*minEVT*/0.25f, /*maxEVT*/10f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.VARIEGATED_RUSSULA, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Africa","Europe","Asia"},
				/*size*/6, /*dispersion*/5, /*rarity*/4396, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/5f, /*maxTemp*/18f, /*minRain*/850f, /*maxRain*/1900f, /*minEVT*/0.25f, /*maxEVT*/10f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.YELLOW_SWAMP_RUSSULA, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  new String[] {"Swamp","Salt Swamp","Estuary","Riverbank","Plains","Lakeshore"}, new String[]{"Americas","Africa","Europe","Asia"},
				/*size*/6, /*dispersion*/5, /*rarity*/3196, /*minAltitude*/0, /*maxAltitude*/160, /*minTemp*/3f, /*maxTemp*/17f, /*minRain*/550f, /*maxRain*/1600f, /*minEVT*/0.25f, /*maxEVT*/2f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.SHORT_STEMMED_RUSSULA, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Europe"},
				/*size*/6, /*dispersion*/5, /*rarity*/3296, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/-4f, /*maxTemp*/18f, /*minRain*/950f, /*maxRain*/16000f, /*minEVT*/0.25f, /*maxEVT*/10f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.SHRIMP_RUSSULA, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Europe"},
				/*size*/6, /*dispersion*/5, /*rarity*/4596, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/-8f, /*maxTemp*/29f, /*minRain*/750f, /*maxRain*/1600f, /*minEVT*/0.25f, /*maxEVT*/10f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.LOBSTER_MUSHROOM, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas"},
				/*size*/3, /*dispersion*/5, /*rarity*/7596, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/-8f, /*maxTemp*/29f, /*minRain*/550f, /*maxRain*/1900f, /*minEVT*/0.25f, /*maxEVT*/10f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.HEDGEHOG_MUSHROOM, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Europe"},
				/*size*/3, /*dispersion*/1, /*rarity*/3696, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/5f, /*maxTemp*/14f, /*minRain*/760f, /*maxRain*/1500f, /*minEVT*/0f, /*maxEVT*/8f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.LIBERTY_CAP, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Europe","Asia"},
		...
		athsPlantHelper(AthsGlobal.PARASOL_MUSHROOM, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Africa","Europe"},
				/*size*/4, /*dispersion*/5, /*rarity*/3596, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/6f, /*maxTemp*/18f, /*minRain*/450f, /*maxRain*/870f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.THE_VOMITER, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Africa","Europe","Asia"},
				/*size*/4, /*dispersion*/5, /*rarity*/4596, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/7f, /*maxTemp*/26f, /*minRain*/450f, /*maxRain*/870f, /*minEVT*/0f, /*maxEVT*/10f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.SHRIMP_OF_THE_WOODS, new int[] {0,1}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Europe","Asia"},
				/*size*/2, /*dispersion*/2, /*rarity*/5796, /*minAltitude*/0, /*maxAltitude*/255, /*minTemp*/-4f, /*maxTemp*/15f, /*minRain*/750f, /*maxRain*/16000f, /*minEVT*/1f, /*maxEVT*/7f,/*forestGen*/1.0f);
		athsPlantHelper(AthsGlobal.SLIPPERY_JACK, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Asia","Africa","Europe"},
		...
		athsPlantHelper(AthsGlobal.YELLOW_KNIGHT, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Asia","Europe","Africa"},
		...
		athsPlantHelper(AthsGlobal.RED_CRACKING_BOLETE, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Asia"},
		...
		athsPlantHelper(AthsGlobal.PEAR_SHAPED_PUFFBALL, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Europe","Asia","Africa"},
		...
		athsPlantHelper(AthsGlobal.GREGS_MOUSTACHE, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass","ore:blockSand","ore:blockGravel"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Europe","Asia","Africa"},
		...
		athsPlantHelper(AthsGlobal.BITTER_BOLETE, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Europe","Asia"},
		...
		athsPlantHelper(AthsGlobal.BRICK_CAP, new int[] {0}, new String[] {"ore:blockSoil","terrafirmacraftplus:Peat_Grass"},  AthsGlobal.LAND_BIOMES, new String[]{"Americas","Europe","Asia"},
