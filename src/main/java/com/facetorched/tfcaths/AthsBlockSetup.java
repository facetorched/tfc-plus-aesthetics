...
public class AthsBlockSetup {
	...
	public static void setup() {
		...
		maidenhairFern = plantRegistryHelper(new BlockPlant3d().setName(AthsGlobal.MAIDENHAIR_FERN).addVarys(new EnumVary[] {EnumVary.WINTER, EnumVary.SNOW}).setVaryPart(EnumVary.DEFAULT, "Frond").setNamedPart("Stem").setScale(1.3f));
