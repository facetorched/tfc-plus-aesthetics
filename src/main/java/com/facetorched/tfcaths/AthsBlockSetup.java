...
public class AthsBlockSetup {
	...
	public static Block travellersPalm;
	...
	public static void setup() {
		...
		rattlesnakePlant = plantRegistryHelper(new BlockPlantFlower().setName(AthsGlobal.RATTLESNAKE_PLANT).setScale(2.0f));
		...
		morel = plantRegistryHelper(new BlockPlantFungus().setName(AthsGlobal.MOREL).setBrownMushroom(4f).setScale(0.8f));
		...
		enoki = plantRegistryHelper(new BlockPlantEpiphyte3dFungus().setNames(AthsGlobal.ENOKI, new String[] {"Enokitake", "Velvet_Shank"}).setOverrideModelName("Enoki").setPart("Sporocarp").setBrownMushroom(40f));
